...
import "./interfaces/IStrategyHelperCake.sol";

// no storage
// There are only calculations for apy, tvl, etc.
contract StrategyHelperCake is IStrategyHelperCake {
    ...
    ICakeMasterChef private constant master = ICakeMasterChef(0x73feaa1eE314F8c655E354234017bE2193C9E24E);
